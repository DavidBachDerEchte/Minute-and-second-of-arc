...
function updateCircle() {
  ...
  const whatIsIt = document.createElement("h1");

  if (numberOfLines >= 360) {
    whatIsIt.innerText = "Jede Lücke ist 1°";
    whatIsItId.appendChild(whatIsIt);
  } else if (numberOfLines >= 21600) {
    whatIsIt.innerText = "Jede Lücke ist 1 Arc-minute groß";
    whatIsItId.appendChild(whatIsIt);
  } else if (numberOfLines >= 1296000) {
    whatIsIt.innerText = "Jede Lücke ist 1 Arc-sekunde groß";
    whatIsItId.appendChild(whatIsIt);
  } else if (numberOfLines >= 77760000) {
    whatIsIt.innerText = "Jede Lücke ist 1 Milli-arc-sekunde groß";
    whatIsItId.appendChild(whatIsIt);
  } else if (numberOfLines >= 4665600000) {
    whatIsIt.innerText = "Jede Lücke ist 1 Micro-arc-sekunde groß";
    whatIsItId.appendChild(whatIsIt);
  } else {
